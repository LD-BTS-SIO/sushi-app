...
* Ce fichier index.html est le point d'entrée de notre application Angular. Il définit la structure de base de la page HTML où votre application sera rendue dans le navigateur. 
