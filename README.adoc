= Compte rendu final du dossier Sushi-app
:toc:
...
** <app-root>: C'est le sélecteur du composant racine (AppComponent) de notre application Angular. Tout le contenu de l'application Angular sera rendu à l'intérieur de cette balise.
