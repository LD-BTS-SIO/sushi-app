...
*Amorçage du module racine (AppModule) :
...
=== Contenu du fichier .editorconfig
...
=== Utilité du fichier .editorconfig
...
=== Structure générale du fichier angular.json
...
=== Utilité du fichier angular.json
...
=== Utilité du fichier package.json :
...
=== Utilité du fichier tsconfig.app.json :
...
=== Utilité du fichier tsconfig.json :
...
=== Principales propriétés du fichier tsconfig.spec.json :
...
=== Utilité du fichier tsconfig.spec.json :
