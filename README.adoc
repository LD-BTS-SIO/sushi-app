...
====
image::src/assets/img/politique.png[width=500,title=" Mentions légaleset RGPD", alt=""]
====
====
image::src/assets/img/rgpd.png[width=500, title="Création des 4 fichiers dû à la commande", alt=""]
====
